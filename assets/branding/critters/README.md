...
| `plane-2.png` | `drafts/v11-recraft/plane-prop-2.png` (propeller angle companion) |
...
with a 2-frame propeller swap; flight altitude is randomized. Gopher peek sits
slightly below the screen edge.
