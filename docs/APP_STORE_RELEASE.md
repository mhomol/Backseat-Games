...
- [ ] **Paid Apps Agreement** active (Agreements, Tax, and Banking)
- [ ] App record exists: **Backseat Games (road trip fun)**
...
- [ ] **Subtitle** (30 chars) — e.g. `Road trip games for the car`
- [ ] **Primary category** — Games → Family (or Travel)
- [ ] **Secondary category** — optional
- [ ] **Age rating** questionnaire — expect 4+; declare local network + optional mic honestly
