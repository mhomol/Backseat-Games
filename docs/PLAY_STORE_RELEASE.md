...
| Marketing version | `1.2.0` (`version` / Play `versionName`) |
...
- [ ] Identity + **physical Android device** verification (Play Console mobile app)
- [ ] Accept Play App Signing
- [ ] Internal testing track: add yourself (and family) as testers
- [ ] Google Cloud service account with Play Console API access (Release Manager) — JSON for CI / EAS Submit
...
- [ ] App name: **Backseat Games**
- [ ] Short description — solo road-trip games; multiplayer coming soon if mentioned
- [ ] Full description — adapt iOS copy; stress **free solo**, no paywall in v1
- [ ] Screenshots (phone): home, host setup, each game; optional Coming soon toast
- [ ] Feature graphic / icon as required by Console
